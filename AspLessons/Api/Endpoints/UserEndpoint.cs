    ...
    public static class UserEndpoint
    {
        ...
        public static IEndpointRouteBuilder MapUser(this IEndpointRouteBuilder userGroup)
        {
                ...
                [FromServices] IUserService userService, IMapper mapper) =>
            {
                ...
                FavorsByMasterResponse response = new FavorsByMasterResponse()
                {
                ...
                .RequireAuthorization("client")
                .WithSummary("Получение списка услуг");
            ...
            {
                var response = await userService.LoginUser(request.PhoneNumber, request.Password);
