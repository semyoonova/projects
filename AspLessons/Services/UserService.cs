...
{
    public class UserService(IMasterService masterService, IRegisterService registerService, IMapper mapper,
        ...
        IPasswordHasher<User> passwordHasher, ILogger<UserService> logger) : IUserService
    {
        ...
        public async Task<Register> RegistrationToFavor(RegisterDto registerDto)
        {
            ...
            return await registerService.CreateRegister(registerDto);
        }
