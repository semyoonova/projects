...
builder.Services.AddAuthorizationBuilder()
    ...
    .AddPolicy("user", policy => policy.RequireRole("admin", "client"));
...
LogManager.Setup()
    .SetupExtensions(ext => ext.RegisterConfigSettings(builder.Configuration))
    .LoadConfigurationFromFile("NLogConfig.xml");
